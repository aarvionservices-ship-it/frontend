    ...
    return (
        <section className="py-10 bg-background border-b border-gray-800">
            <div className="container-custom">
                <p className="text-center text-sm text-gray-500 mb-6 uppercase tracking-widest">Trusted By</p>
                <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                    ...
                    {['Company A', 'Company B', 'Company C', 'Company D', 'Company E'].map((client, idx) => (
                        <div key={idx} className="text-xl font-bold text-gray-400">{client}</div>
                    ))}
                </div>
            </div>
        </section>

        ...
        <section className="section-padding bg-background">
            <div className="container-custom">
                <div className="text-center mb-16">
                    ...
                    <p className="text-text-muted">A timeline of our growth and achievements.</p>
                </div>
                    ...
                    <div className="space-y-12">
                        {milestones.map((item, index) => (
                            <div key={index} className={`flex flex-col md:flex-row items-center justify-between ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                                ...
                                <div className="w-full md:w-5/12 bg-surface p-6 rounded-2xl border border-border hover:border-primary/30 transition-all">

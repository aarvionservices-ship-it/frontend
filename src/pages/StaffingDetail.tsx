                ...
                <section className="bg-surface py-20 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        <motion.div
                            ...
                            className="max-w-4xl"
                        >
                            <Link to="/staffing" className="inline-flex items-center text-primary hover:text-text transition-colors mb-6 group">
                    ...
                    <div className="container-custom grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <div className="bg-surface p-8 rounded-2xl border border-border">
                                <h2 className="text-2xl font-bold text-text mb-6">Key Offerings</h2>
                            ...
                            {/* Benefits */}
                            <div>
                                <h2 className="text-2xl font-bold text-text mb-6">Why Choose Our {data.title}?</h2>
                                <div className="space-y-4">
                                    {data.benefits.map((benefit, index) => (
                                        <div key={index} className="flex p-4 rounded-xl bg-surface/50 border border-border hover:border-primary/30 transition-colors">
                                            <div className="mr-4 mt-1 bg-primary/10 p-2 rounded-full text-primary">
                                                <ArrowRight size={16} />
                                            </div>
                                            <div>
                                                <h4 className="text-text font-semibold mb-1">{benefit}</h4>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-primary/10 p-8 rounded-2xl border border-primary/20">
                                <h3 className="text-2xl font-bold text-text mb-4">Need {data.title}?</h3>
                            ...
                            <div className="bg-surface p-8 rounded-2xl border border-border">
                                <h3 className="text-xl font-bold text-text mb-4">Other Solutions</h3>
                                    ...
                                    {Object.entries(staffingData).map(([key, value]) => (
                                        key !== slug && (
                                            <Link
                                                key={key}
                                                to={`/staffing/${key}`}
                                                className="block p-3 rounded-lg hover:bg-surface/50 text-text-muted hover:text-text transition-colors flex items-center justify-between group"
                                            >

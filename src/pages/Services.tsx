            ...
            <main className="pt-20">
                ...
                <section className="bg-surface py-20 text-center relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Our Expertise</h1>
                ...
                <section className="section-padding bg-background">
                    <div className="container-custom grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service) => (
                            <div key={service.id} className="group p-8 rounded-2xl bg-surface border border-white/5 hover:border-primary/50 hover:shadow-2xl transition-all duration-300">
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center text-white font-semibold hover:text-primary transition-colors group-hover:translate-x-2 duration-300"
                                >

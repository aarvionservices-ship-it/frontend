...
const BlogPost: React.FC = () => {
    ...
    if (!post) {
        return (
            <div className="min-h-screen pt-32 pb-20 container-custom text-white text-center">
            ...
            <main className="pt-24 pb-20">
                <article className="container-custom max-w-4xl">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-center text-muted space-x-6 border-b border-gray-800 pb-8">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none text-gray-300">
                        ...
                        <h2 className="text-2xl font-bold text-white mt-10 mb-4">Looking Ahead</h2>
                        <p className="mb-6">
                    ...
                    <div className="mt-16 pt-8 border-t border-gray-800">
                        ...
                        <div className="flex gap-2">
                            {['Technology', 'Business', 'Growth'].map(tag => (
                                <span key={tag} className="bg-surface px-3 py-1 rounded text-sm text-muted flex items-center">
